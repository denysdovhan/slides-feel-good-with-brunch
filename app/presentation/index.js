    ...
    return (
      <Spectacle theme={theme}>
        <Deck transition={["fade"]} transitionDuration={300}>
          ...
          <Slide>
            <Heading size={2}>Тулза для тих, в кого бомбить</Heading>
          </Slide>
          ...
          <Slide>
            <Text margin="1rem 0 0"><S type="underline bold">Brunch (2011)</S></Text>
          ...
          <Slide>
            <Heading size={2}>
              Слайд про те, як все <S type="italic" style="">стало</S> круто
            </Heading>
          </Slide>
